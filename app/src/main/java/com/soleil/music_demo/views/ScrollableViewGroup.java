package com.soleil.music_demo.views;
...
public class ScrollableViewGroup extends ViewGroup {
    ...
    private void initViewGroup() {
        ...
        mTouchSlop = configuration.getScaledTouchSlop();//最小翻页需要的手的滑动距离
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                final int touchSlop = mTouchSlop;//最小滑动距离
                ...
                if (xMoved || yMoved) {
                    ...
                    if (mAllowLongPress) {
                        ...
                        currentScreen.cancelLongPress();//取消长按
                    }
                }
                break;
